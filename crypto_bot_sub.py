...
class CryptoTradingBot:
    ...
    def generate_signals(self, symbol, df_5min, df_hourly):
        ...
        if symbol == 'bcc_jpy':
            ...
            df_5min.loc[df_5min['rsi_score_long'].between(0.49, 0.53),'buy_signal'] = False
        ...
        if symbol == 'ltc_jpy':
            ...
            df_5min.loc[df_5min['bb_score_long'].between(0.156, 0.23),'buy_signal'] = False
        ...
        if symbol == 'xrp_jpy':
            ...
            df_5min.loc[df_5min['adx_score_short'] < 0.141, 'sell_signal'] = False
